...
class ColorIndicatorBuilder {
    ...
    public static colorIndicatorBuilder: ColorIndicatorBuilder = new ColorIndicatorBuilder()
    ...
    public build(colorIndicatorDisplay: Display): void {
        ...
        let outerRectangle = new Rectangle(
            -colorIndicatorDisplay.getWidth() / 4,
            colorIndicatorDisplay.getHeight() / 2,
            colorIndicatorDisplay.getWidth() / 4,
            colorIndicatorDisplay.getHeight()
        )
            ...
            for (let i = 0; i < totalNumberOfInnerRectangles; ++i) {
                ...
                this.graphicalComposite.add(
                    new Tetragon(
                        ...
                        innerRectangle.x + innerRectangle.width, innerRectangle.y,
                        innerRectangle.x + innerRectangle.width, innerRectangle.y + innerRectangle.height,
                        innerRectangle.x, innerRectangle.y + innerRectangle.height,
                        color
                    )
                )
            }
        ...
        this.graphicalComposite.add(
            new Label(
                outerRectangle.x + outerRectangle.width * 1.7 - 170,
                // outerRectangle.y - 70,
                outerRectangle.y + 100,
                "ergs/cm2s",
